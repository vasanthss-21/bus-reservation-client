...
import { FaEnvelope, FaTicketAlt, FaChair, FaClock, FaRoute, FaSpinner, FaInbox } from 'react-icons/fa';
            ...
            <div key={booking.id ?? idx} className="rounded-2xl p-4 sm:p-5 transition-shadow hover:shadow-md"
              ...
              <div className="grid grid-cols-1 sm:grid-cols-3 gap-2 sm:gap-3">
                <div className="flex items-start gap-2">
                  <FaRoute className="text-indigo-400 mt-0.5 flex-shrink-0 text-xs" />
                  <div>
                    <p className="text-[10px] sm:text-xs text-gray-400 font-medium">Route ID</p>
                    <p className="text-xs sm:text-sm font-semibold text-gray-700 break-all">{booking.routeId}</p>
                  </div>
                </div>
                <div className="flex items-start gap-2">
